...
namespace OnlineAdmission.DB.Migrations
{
    ...
    [Migration("20220207072253_paymentstatusAddedtoPaymentTransaction")]
    partial class paymentstatusAddedtoPaymentTransaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.MeritType", b =>
                {
                    ...
                    b.Property<string>("MeritTypeName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PaymentTypeShortCode")
                        .IsRequired()
                        .HasMaxLength(4)
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.SMSModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.Student", b =>
                {
                    ...
                    b.Property<int?>("PreviousCollegeRoll")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.StudentCategory", b =>
                {
                    ...
                    b.Property<string>("IDCardShortName")
                        .HasMaxLength(7)
            ...
            modelBuilder.Entity("OnlineAdmission.Entity.StudentPaymentType", b =>
                {
                    ...
                    b.HasOne("OnlineAdmission.Entity.PaymentType", "PaymentType")
                        .WithMany("StudentPaymentTypes")
